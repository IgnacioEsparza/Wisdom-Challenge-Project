...
<<<<<<< Upstream, based on Manuel/master
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users"
                    ...
                    + "\\Wisdom-Challenge\\Wisdom-Challenge-Proyect\\resCorrectas.wis"));
     ...
     public String todRespuestas(int pos) {
        ...
        try { 
            ...
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users"
                    + "\\Ignacio Esparza\\Documents\\NetBeansProjects"
                    + "\\Wisdom-Challenge\\Wisdom-Challenge-Proyect\\todRespuestas.wis"));
=======
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\mepr9\\Documents\\NetBeansProjects\\Wisdom-Challenge-Proyect\\Wisdom-Challenge-Proyect\\resCorrectas.wis"));
            String guardaRespCorrecta;
            while ((guardaRespCorrecta = br.readLine()) != null) {
                String respuesta [] = guardaRespCorrecta.split(",");
                return respuesta[pos]; 
     ...
     public String todRespuestas(int pos) {
        ...
        try { 
            ...
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\mepr9\\Documents\\NetBeansProjects\\Wisdom-Challenge-Proyect\\Wisdom-Challenge-Proyect\\todRespuestas.wis"));
