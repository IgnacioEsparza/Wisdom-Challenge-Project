...
public class Ventana extends javax.swing.JFrame {
    ...
    int pos;
    int cont=0;
    int llamarPreguntas[] = c.preguntaRandom();
    public Ventana() {
        initComponents();
    ...
    private void configuracion() {
         // los números de la pregunta en un arreglo, de forma aleatoria
        if(cont<11){
            pos = llamarPreguntas[cont];// el numero de la posicion del contador mietras va aunmentando
            numeroPregunta.setText(String.valueOf(cont+1));
            System.out.println("");
            System.out.println("Pocicion ventana "+pos);
